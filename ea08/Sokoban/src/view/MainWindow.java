...
public class MainWindow extends JFrame{
            ...
            public void keyPressed(KeyEvent ke) {
                ...
                if (d != null && game.step(d)){
                    if (game.getLevelNumBoxes() == game.getLevelNumBoxesInPlace()){
                        JOptionPane.showMessageDialog(MainWindow.this, "Congratulation!", "Congratulation!", JOptionPane.INFORMATION_MESSAGE);
                    }
                } 
            }
        });
    ...
    private void refreshGameStatLabel(){
        ...
        s += ", boxes at right position: " + game.getLevelNumBoxesInPlace() + "/" + game.getLevelNumBoxes();
