...
public class ClickCounter extends JFrame
{
    ...
    public ClickCounter()
    {
        ...
        menuReset.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O, KeyEvent.CTRL_MASK));
        menuReset.setEnabled(false);
        ...
        menuExit.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, KeyEvent.ALT_MASK));
