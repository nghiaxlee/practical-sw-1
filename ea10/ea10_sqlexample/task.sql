-- There is a payroll system:
--   it contains the employees (name, id, salary)
--   it records, who and when arrived and left 
--   the company offers flexible working hours, but an employee needs to work 40 hours a week
--   there is a 30 minutes lunch time, which doesn't count as worktime
--   company pays 20% more for overtimes
--   if an employee works less than 8 hours / day in average in a month,
--   then he gets the wage in proportion to worked hours
